    ...
    <div className="checkout">
        ...
        <div className="checkout__details__list">
          ...
          <div className="cart__productList">
              {cartList.map((cartProduct: CartProductObject) => {
                  return <CartProduct checkout={true} updateQuantity={() => {}} product={cartProduct} handleTrash={() => {}}></CartProduct>
              })}
          </div>
        </div>
      </div>
      <div className="checkout__summary">
        ...
        <div className="checkout__summary__total">
          ...
          <p className="checkout__summary__total__value">Taxes: ${total * 0.13}</p>
          <p className="checkout__summary__total__total">Total: ${(total * 0.13) + total}</p>
        </div>
