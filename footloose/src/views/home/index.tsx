...
const Home = () => {
    ...
    return(
        <>
            ...
            {popularProducts !== null ? <div className="homePage__gallery">
                <h2 className="homePage__gallery__title">Most popular</h2>
                <div className="homePage__gallery__container">
                {popularProducts.map((product) => (
                    <Link className="homePage__gallery__item" to={"details/"+ (product.id || "")}>
                        <Card className="homePage__gallery__item">
                            <Card.Img className="homePage__gallery__item__image" variant="top" src={product.image || "./images/shoes1.jpg"} alt={(product.name || "") + " image"}/>
                            <Card.Body>
                                <Card.Title className="homePage__gallery__item__name">{product.name}</Card.Title>
                                <Card.Text>
                                    <p>{product.brand}</p>
